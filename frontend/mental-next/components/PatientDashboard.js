            ...
            <div className="glass sticky top-0 z-50 shadow-sm backdrop-blur-xl border-b border-white/40">
                <div className="max-w-2xl mx-auto px-4 py-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            onClick={onLogout}
                            className="flex items-center justify-center rounded-full text-slate-400 hover:text-red-500 hover:bg-red-50 transition-all active:scale-95 px-3 py-1 font-bold gap-2"
                            title="Logout"
                        >
            ...
            <div className="max-w-2xl mx-auto px-4 py-10">
                ...
                <div className="space-y-8">
                    {posts.map((post, index) => (
                        <div
                            key={post.id}
                            className={`glass-card rounded-[2.5rem] shadow-sm p-8 transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-500/5 border-white/60 animate-fade-in-up`}
                        ...
                        >
                            <div className="flex justify-between items-start mb-6">
                                ...
                                {/* AI Badge */}
                                { /* AI Badge Hidden for User Privacy */}
                            </div>
                            ...
                            { /* Analyzing Indicator Hidden */}

                            { /* AI Analysis Results Hidden */}
